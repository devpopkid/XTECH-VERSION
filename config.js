...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "POPKID;;;session env",
// add your Session Id 
...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*VIEWED YOUR STATUS🦋*",
...
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*©popkid engines*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/mua6vc.jpg",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "*popkid never sleeps 🍀*",
// add alive msg here 
