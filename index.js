...
const port = process.env.PORT || 9090;
  ...
  let up = `✅✨ 𝐏𝐨𝐩𝐊𝐢𝐝X𝐓𝐞𝐜𝐡 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐂𝐨𝐧𝐧𝐞𝐜𝐭𝐞𝐝! ✨✅
...
╭──〔 🔗 Quick Links 〕
├─ 📢 Updates: https://whatsapp.com/channel/0029VbB6d0KKAwEdvcgqrH26  
├─ ⭐ GitHub: https://github.com/devpopkid/XTECH-VERSION  
╰─ 🛠 Prefix: ${prefix}
`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/mua6vc.jpg` }, caption: up })
  }
  })
